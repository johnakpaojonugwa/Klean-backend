...
import { validateBranchCreation, validatePaginationParams, validateBranchUpdate } from "../middlewares/validateRequest.js";
...
router.put('/:branchId', auth, authorize('SUPER_ADMIN'), validateBranchUpdate, asyncHandler(updateBranch));
